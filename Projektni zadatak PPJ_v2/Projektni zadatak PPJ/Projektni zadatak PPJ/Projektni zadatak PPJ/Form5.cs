    ...
    public partial class Form5 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    errorProvider1.Clear();
                    String upit = "DELETE FROM stavka_narudzbenice WHERE narudzbenica_id='" + textBox1.Text + "'";
                    String upit2 = "DELETE FROM narudzbenica WHERE narudzbenica_id='" + textBox1.Text + "'";
